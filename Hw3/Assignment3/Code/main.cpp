...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
	...
	float t = abs(zNear) * std::tan(halfEyeAngelRadian);//top y轴的最高点
    ...
    float halfEyeAngelRadian = eye_fov / 2.0 / 180.0 * MY_PI;
	float top = -tan(halfEyeAngelRadian) * abs(zNear);
...
Eigen::Vector3f phong_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    auto l1 = light{{20, 20, 0}, {500, 500, 500}};
    auto l2 = light{{-20, 20, 0}, {500, 500, 500}};
...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "D:/Study/project/VS c++project/delete/models/spot/";

    // Load .obj File
    bool loadout = Loader.LoadFile("D:/Study/project/VS c++project/delete/models/spot/spot_triangulated_good.obj");
